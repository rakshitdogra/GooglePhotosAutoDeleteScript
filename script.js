// Enter in the > const maxImageCount = 5896 to specify the number of photos you want to delete.
const maxImageCount = "ALL_PHOTOS";

// Selector for Images and buttons
// Zooming out the weabpage as much as possible. ( In addition to Ctrl + [-] )
